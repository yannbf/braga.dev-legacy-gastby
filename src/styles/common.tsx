...
export const media = Object.keys(sizes).reduce((acc: Record<string, any>, label) => {
  acc[label] = (...args: any) =>
    css`
...
export const textColor = {
  ...
  `,
  title: css`
    color: ${(props) => (props.theme && props.theme.color === 'light' ? colors.textTitleLight : colors.textTitleDark)};
  `,
};
